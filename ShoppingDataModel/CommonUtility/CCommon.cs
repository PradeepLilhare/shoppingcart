...
namespace ShoppingDataModel.CommonUtility
{
    ...
    {
        public static char[] arrCategorySplitChars = { ',' };
        public static string strEmailFrom = ConfigurationManager.AppSettings["fromdisplayname"].ToString();
        public static string strAdminEmailID = ConfigurationManager.AppSettings["errormailid"].ToString();
